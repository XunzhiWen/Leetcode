...
<div><div>Related Topics</div><div><li>Array</li><li>Two Pointers</li></div></div><br><div><li>👍 5352</li><li>👎 7129</li></div>
*/
...
class Solution {
    public int removeElement(int[] nums, int val) {
        /* Similar Idea with Problem 26, using 2 pointers, one for traversing and the other for palcing
        * qualified number into the array */
        int index=0;
