...
is in that room.
 ...
 Related Topics Depth-First Search Breadth-First Search Graph 👍 6575 👎 297
...
class Solution {
    ...
    private void dfs(List<List<Integer>> rooms, HashSet<Integer> visited, int curRoom) {
        if (visited.contains(curRoom)) return;
        visited.add(curRoom);
